...
#define OS_PRIO_MUTEX_CEIL_DIS                                                 \
  0xFFu /* Disable mutex priority ceiling promotion    */
...
#define OS_TASK_STAT_PRIO                                                      \
  (OS_LOWEST_PRIO - 1u) /* Statistic task priority                     */
#define OS_TASK_IDLE_PRIO                                                      \
  (OS_LOWEST_PRIO) /* IDLE      task priority                     */

#if OS_LOWEST_PRIO <= 63u
#define OS_EVENT_TBL_SIZE                                                      \
  ((OS_LOWEST_PRIO) / 8u + 1u)                       /* Size of event table    \
                                                      */
#define OS_RDY_TBL_SIZE ((OS_LOWEST_PRIO) / 8u + 1u) /* Size of ready table */
#else
#define OS_EVENT_TBL_SIZE                                                      \
  ((OS_LOWEST_PRIO) / 16u + 1u) /* Size of event table */
#define OS_RDY_TBL_SIZE                                                        \
  ((OS_LOWEST_PRIO) / 16u + 1u) /* Size of ready table                         \
                                 */
#endif
...
#define OS_EVENT_EN                                                            \
  (((OS_Q_EN > 0u) && (OS_MAX_QS > 0u)) || (OS_MBOX_EN > 0u) ||                \
   (OS_SEM_EN > 0u) || (OS_MUTEX_EN > 0u))
...
#define OS_STAT_RDY                                                            \
  0x00u /* Ready to run                                            */
#define OS_STAT_SEM                                                            \
  0x01u /* Pending on semaphore                                    */
#define OS_STAT_MBOX                                                           \
  0x02u /* Pending on mailbox                                      */
#define OS_STAT_Q                                                              \
  0x04u /* Pending on queue                                        */
#define OS_STAT_SUSPEND                                                        \
  0x08u /* Task is suspended                                       */
#define OS_STAT_MUTEX                                                          \
  0x10u /* Pending on mutual exclusion semaphore                   */
#define OS_STAT_FLAG                                                           \
  0x20u /* Pending on event flag group                             */
#define OS_STAT_MULTI                                                          \
  0x80u /* Pending on multiple events                              */

#define OS_STAT_PEND_ANY                                                       \
...
*********************************************************************************************************
*/
#define OS_STAT_PEND_OK                                                        \
  0u /* Pending status OK, not pending, or pending complete     */
#define OS_STAT_PEND_TO                                                        \
  1u /* Pending timed out                                       */
#define OS_STAT_PEND_ABORT                                                     \
  2u /* Pending aborted                                         */
...
#define OS_TICK_STEP_DIS                                                       \
  0u /* Stepping is disabled, tick runs as normal               */
#define OS_TICK_STEP_WAIT                                                      \
  1u /* Waiting for uC/OS-View to set OSTickStepState to _ONCE  */
#define OS_TICK_STEP_ONCE                                                      \
  2u /* Process tick once and wait for next cmd from uC/OS-View */
#endif

/*
*********************************************************************************************************
*      Possible values for 'opt' argument of OSSemDel(), OSMboxDel(), OSQDel()
*and OSMutexDel()
*********************************************************************************************************
*/
...
*********************************************************************************************************
*/
#define OS_PEND_OPT_NONE                                                       \
  0u /* NO option selected                                      */
#define OS_PEND_OPT_BROADCAST                                                  \
  1u /* Broadcast action to ALL tasks waiting                   */

/*
*********************************************************************************************************
*                                     OS???PostOpt() OPTIONS
*
* These #defines are used to establish the options for OSMboxPostOpt() and
*OSQPostOpt().
*********************************************************************************************************
*/
#define OS_POST_OPT_NONE                                                       \
  0x00u /* NO option selected                                      */
#define OS_POST_OPT_BROADCAST                                                  \
  0x01u /* Broadcast message to ALL tasks waiting                  */
#define OS_POST_OPT_FRONT                                                      \
  0x02u /* Post to highest priority task waiting                   */
#define OS_POST_OPT_NO_SCHED                                                   \
  0x04u /* Do not call the scheduler if this option is selected    */
...
*********************************************************************************************************
*/
#define OS_TMR_OPT_NONE                                                        \
  0u /* No option selected                                      */

#define OS_TMR_OPT_ONE_SHOT                                                    \
  1u /* Timer will not automatically restart when it expires    */
#define OS_TMR_OPT_PERIODIC                                                    \
  2u /* Timer will     automatically restart when it expires    */

#define OS_TMR_OPT_CALLBACK                                                    \
  3u /* OSTmrStop() option to call 'callback' w/ timer arg.     */
#define OS_TMR_OPT_CALLBACK_ARG                                                \
  4u /* OSTmrStop() option to call 'callback' w/ new   arg.     */
...
typedef struct os_event {
  INT8U
  OSEventType; /* Type of event control block (see OS_EVENT_TYPE_xxxx)    */
  void *OSEventPtr;  /* Pointer to message or queue structure  */
  INT16U OSEventCnt; /* Semaphore Count (not used if other EVENT type) */
  OS_PRIO
  OSEventGrp; /* Group corresponding to tasks waiting for event to occur */
  OS_PRIO OSEventTbl[OS_EVENT_TBL_SIZE]; /* List of tasks waiting for event to
                                            occur                */
...
#if OS_FLAGS_NBITS ==                                                          \
    8u /* Determine the size of OS_FLAGS (8, 16 or 32 bits)       */
...
typedef struct os_mem_data {
  ...
  void
      *OSFreeList; /* Ptr to the beginning of the free list of memory blocks  */
...
typedef struct os_q { /* QUEUE CONTROL BLOCK */
  struct os_q
      *OSQPtr;     /* Link to next queue control block in list of free blocks */
...
typedef struct os_tcb {
  ...
  OS_EVENT *
      *OSTCBEventMultiPtr; /* Pointer to multiple  event control blocks      */
  OS_EVENT *OSTCBEventMultiRdy; /* Pointer to the first event control block
                                   readied        */
#endif
  ...
  INT32U OSTCBCyclesTot;   /* Total number of clock cycles the task has been
                              running  */
  INT32U OSTCBCyclesStart; /* Snapshot of cycle counter at start of task
                              resumption   */
...
#if OS_TASK_CREATE_EXT_EN > 0u
#if defined(OS_TLS_TBL_SIZE) && (OS_TLS_TBL_SIZE > 0u)
typedef void (*OS_TLS_DESTRUCT_PTR)(OS_TCB *ptcb, OS_TLS_ID id, OS_TLS value);
#endif
#endif
...
#if (OS_EVENT_EN) && (OS_MAX_EVENTS > 0u)
OS_EXT OS_EVENT
    *OSEventFreeList; /* Pointer to list of free EVENT control blocks    */
OS_EXT OS_EVENT OSEventTbl[OS_MAX_EVENTS]; /* Table of EVENT control blocks */
#endif

#if (OS_FLAG_EN > 0u) && (OS_MAX_FLAGS > 0u)
OS_EXT OS_FLAG_GRP
    OSFlagTbl[OS_MAX_FLAGS]; /* Table containing event flag groups */
OS_EXT OS_FLAG_GRP
    *OSFlagFreeList; /* Pointer to free list of event flag groups       */
#endif
...
OS_EXT OS_STK
    OSTaskStatStk[OS_TASK_STAT_STK_SIZE]; /* Statistics task stack          */
#endif
...
OS_EXT OS_TCB *
    OSTCBPrioTbl[OS_LOWEST_PRIO + 1u]; /* Table of pointers to created TCBs   */
OS_EXT OS_TCB OSTCBTbl[OS_MAX_TASKS + OS_N_SYS_TASKS]; /* Table of TCBs */

#if OS_TICK_STEP_EN > 0u
OS_EXT INT8U
    OSTickStepState; /* Indicates the state of the tick step feature    */
#endif
...
OS_EXT OS_EVENT
    *OSTmrSemSignal; /* Sem. used to signal the update of timers        */
...
INT16U OSEventPendMulti(OS_EVENT **pevents_pend, OS_EVENT **pevents_rdy,
                        void **pmsgs_rdy, INT32U timeout, INT8U *perr);
#endif
...
OS_TLS OS_TLS_GetValue(OS_TCB *ptcb, OS_TLS_ID id, INT8U *perr);

void OS_TLS_Init(INT8U *perr);

void OS_TLS_SetValue(OS_TCB *ptcb, OS_TLS_ID id, OS_TLS value, INT8U *perr);

void OS_TLS_SetDestruct(OS_TLS_ID id, OS_TLS_DESTRUCT_PTR pdestruct,
                        INT8U *perr);
...
INT8U OSTaskCreate(void (*task)(void *p_arg), void *p_arg, OS_STK *ptos,
                   INT8U prio);
#endif

#if OS_TASK_CREATE_EXT_EN > 0u
INT8U OSTaskCreateExt(void (*task)(void *p_arg), void *p_arg, OS_STK *ptos,
...
OS_TMR *OSTmrCreate(INT32U dly, INT32U period, INT8U opt,
                    OS_TMR_CALLBACK callback, void *callback_arg, INT8U *pname,
                    INT8U *perr);
...
#if (OS_EVENT_NAME_EN > 0u) || (OS_FLAG_NAME_EN > 0u) ||                       \
    (OS_MEM_NAME_EN > 0u) || (OS_TASK_NAME_EN > 0u)
...
#ifndef OS_FLAG_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_FLAG_EN: Enable (1) or Disable (0) code generation for Event Flags"
#else
#ifndef OS_MAX_FLAGS
#error                                                                         \
    "OS_CFG.H, Missing OS_MAX_FLAGS: Max. number of Event Flag Groups in your application"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_FLAGS_NBITS: Determine #bits used for event flags, MUST be either 8, 16 or 32"
#endif

#ifndef OS_FLAG_WAIT_CLR_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_FLAG_WAIT_CLR_EN: Include code for Wait on Clear EVENT FLAGS"
#endif
...
#ifndef OS_MBOX_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_MBOX_EN: Enable (1) or Disable (0) code generation for MAILBOXES"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_MBOX_PEND_ABORT_EN: Include code for OSMboxPendAbort()"
#endif
...
#ifndef OS_MEM_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_MEM_EN: Enable (1) or Disable (0) code generation for MEMORY MANAGER"
#else
...
#ifndef OS_MUTEX_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_MUTEX_EN: Enable (1) or Disable (0) code generation for MUTEX"
#else
...
#ifndef OS_Q_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_Q_EN: Enable (1) or Disable (0) code generation for QUEUES"
#else
#ifndef OS_MAX_QS
...
#ifndef OS_SEM_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_SEM_EN: Enable (1) or Disable (0) code generation for SEMAPHORES"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_SEM_PEND_ABORT_EN: Include code for OSSemPendAbort()"
#endif
...
#ifndef OS_MAX_TASKS
#error                                                                         \
    "OS_CFG.H, Missing OS_MAX_TASKS: Max. number of tasks in your application"
#else
#if OS_MAX_TASKS < 2u
...
#error                                                                         \
    "OS_CFG.H,         OS_MAX_TASKS must be <= OS_LOWEST_PRIO - OS_N_SYS_TASKS + 1"
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_STAT_EN: Enable (1) or Disable(0) the statistics task"
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_STAT_STK_CHK_EN: Check task stacks from statistics task"
#endif

#ifndef OS_TASK_CHANGE_PRIO_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_CHANGE_PRIO_EN: Include code for OSTaskChangePrio()"
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_CREATE_EXT_EN: Include code for OSTaskCreateExt()"
#else
#if (OS_TASK_CREATE_EXT_EN == 0u) && (OS_TASK_CREATE_EN == 0u)
#error                                                                         \
    "OS_CFG.H,         OS_TASK_CREATE_EXT_EN or OS_TASK_CREATE_EN must be Enable (1)"
#endif
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_SUSPEND_EN: Include code for OSTaskSuspend() and OSTaskResume()"
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_REG_TBL_SIZE: Include code for task specific registers"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TICKS_PER_SEC: Sets the number of ticks in one second"
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TIME_DLY_RESUME_EN: Include code for OSTimeDlyResume()"
#endif

#ifndef OS_TIME_GET_SET_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TIME_GET_SET_EN: Include code for OSTimeGet() and OSTimeSet()"
#endif
...
#ifndef OS_TMR_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TMR_EN: When (1) enables code generation for Timer Management"
#elif OS_TMR_EN > 0u
#if OS_SEM_EN == 0u
#error                                                                         \
    "OS_CFG.H, Semaphore management is required (set OS_SEM_EN to 1) when enabling Timer Management."
#error "          Timer management require TWO semaphores."
#endif

#ifndef OS_TMR_CFG_MAX
#error                                                                         \
    "OS_CFG.H, Missing OS_TMR_CFG_MAX: Determines the total number of timers in an application (2 .. 65500)"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TMR_CFG_WHEEL_SIZE: Sets the size of the timer wheel (1 .. 1023)"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_TMR_CFG_TICKS_PER_SEC: Determines the rate at which the timer management task will run (Hz)"
#endif

#ifndef OS_TASK_TMR_STK_SIZE
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_TMR_STK_SIZE: Determines the size of the Timer Task's stack"
#endif
#endif
...
#error                                                                         \
    "OS_CFG.H, Missing OS_ARG_CHK_EN: Enable (1) or Disable (0) argument checking"
#endif

#ifndef OS_CPU_HOOKS_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_CPU_HOOKS_EN: uC/OS-II hooks are found in the processor port files when 1"
#endif

#ifndef OS_APP_HOOKS_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_APP_HOOKS_EN: Application-defined hooks are called from the uC/OS-II hooks"
#endif

#ifndef OS_DEBUG_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_DEBUG_EN: Allows you to include variables for debugging or not"
#endif

#ifndef OS_LOWEST_PRIO
#error                                                                         \
    "OS_CFG.H, Missing OS_LOWEST_PRIO: Defines the lowest priority that can be assigned"
#endif

#ifndef OS_MAX_EVENTS
#error                                                                         \
    "OS_CFG.H, Missing OS_MAX_EVENTS: Max. number of event control blocks in your application"
#else
...
#error                                                                         \
    "OS_CFG.H, Missing OS_SCHED_LOCK_EN: Include code for OSSchedLock() and OSSchedUnlock()"
#endif

#ifndef OS_EVENT_MULTI_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_EVENT_MULTI_EN: Include code for OSEventPendMulti()"
#endif

#ifndef OS_TASK_PROFILE_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_PROFILE_EN: Include data structure for run-time task profiling"
#endif

#ifndef OS_TASK_SW_HOOK_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TASK_SW_HOOK_EN: Allows you to include the code for OSTaskSwHook() or not"
#endif

#ifndef OS_TICK_STEP_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TICK_STEP_EN: Allows to 'step' one tick at a time with uC/OS-View"
#endif

#ifndef OS_TIME_TICK_HOOK_EN
#error                                                                         \
    "OS_CFG.H, Missing OS_TIME_TICK_HOOK_EN: Allows you to include the code for OSTimeTickHook() or not"
#endif
...
#if OS_ARG_CHK_EN < 1u
#error                                                                         \
    "OS_CFG.H, OS_ARG_CHK_EN must be enabled for safety-critical release code"
#endif

#if OS_APP_HOOKS_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_APP_HOOKS_EN must be disabled for safety-critical release code"
#endif
...
#if OS_SCHED_LOCK_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_SCHED_LOCK_EN must be disabled for safety-critical release code if OS_TMR_EN is disabled"
#endif
#endif

#ifdef VSC_VALIDATION_MODE
#error                                                                         \
    "OS_CFG.H, VSC_VALIDATION_MODE must be disabled for safety-critical release code"
#endif

#if OS_TASK_STAT_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_TASK_STAT_EN must be disabled for safety-critical release code"
#endif

#if OS_TICK_STEP_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_TICK_STEP_EN must be disabled for safety-critical release code"
#endif

#if OS_FLAG_EN > 0u
#if OS_FLAG_DEL_EN > 0
#error                                                                         \
    "OS_CFG.H, OS_FLAG_DEL_EN must be disabled for safety-critical release code"
#endif
#endif
...
#if OS_MBOX_DEL_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_MBOX_DEL_EN must be disabled for safety-critical release code"
#endif
#endif
...
#if OS_MUTEX_DEL_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_MUTEX_DEL_EN must be disabled for safety-critical release code"
#endif
#endif
...
#if OS_SEM_DEL_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_SEM_DEL_EN must be disabled for safety-critical release code"
#endif
#endif

#if OS_TASK_DEL_EN > 0u
#error                                                                         \
    "OS_CFG.H, OS_TASK_DEL_EN must be disabled for safety-critical release code"
#endif

#if OS_CRITICAL_METHOD != 3u
#error                                                                         \
    "OS_CPU.H, OS_CRITICAL_METHOD must be type 3 for safety-critical release code"
#endif
